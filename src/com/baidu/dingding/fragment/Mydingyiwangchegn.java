...
/**
 * Created by Administrator on 2015/11/25. 已付款
 */
public class Mydingyiwangchegn extends Fragment implements DResponseListener{
    private View view;
    PullToRefreshListView pullToRefreshListView;
    private int currentPage=1;  //默认是一
    MyyifukuanModel mydindanModel;
    ...
    private void initModel() {
        mydindanModel= new MyyifukuanModel(getActivity());
    ...
    public void onMessageResponse(ReturnBean bean, int result, String message, Throwable error) {
        ...
        if (result == DVolleyConstans.RESULT_OK) {
            if (bean.getType() == DVolleyConstans.METHOD_GEREN_YIFUKUAN) {
                //查询订单
                try {
