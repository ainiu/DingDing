...
import com.baidu.dingding.code.model.MydaishouhuoModel;
import com.baidu.dingding.code.model.MyyifukuanModel;
...
/**
 * Created by Administrator on 2015/11/25. 待收huo
 */
public class Mydingdaishouhuo extends Fragment implements DResponseListener{
    private View view;
    PullToRefreshListView pullToRefreshListView;
    private int currentPage=1;  //默认是一
    MydaishouhuoModel mydindanModel;
    ...
    private void initModel() {
        mydindanModel= new MydaishouhuoModel(getActivity());
    ...
    public void onMessageResponse(ReturnBean bean, int result, String message, Throwable error) {
        ...
        if (result == DVolleyConstans.RESULT_OK) {
            if (bean.getType() == DVolleyConstans.METHOD_GEREN_YIDAOHUO) {
                //查询订单
                try {
