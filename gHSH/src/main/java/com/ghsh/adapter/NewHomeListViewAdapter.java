...
public class NewHomeListViewAdapter extends AbstractBaseAdapter<TNews> {

	public NewHomeListViewAdapter(Context context, List<TNews> list) {
		super(context, list);
	}
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			convertView = LayoutInflater.from(context).inflate(R.layout.activity_news_home_listview_item, null);
