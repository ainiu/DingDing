...
public class GoodsAttrRadioView extends ViewGroup {
	...
	private static final int PADDING_HOR = 10;//水平方向padding
	   ...
	   * @param context
	   */
	  public GoodsAttrRadioView(Context context) {
	    super(context);
	  }
	   ...
	   * @param defStyle
	   */
	  public GoodsAttrRadioView(Context context, AttributeSet attrs, int defStyle) {
	   ...
	   * @param attrs
	   */
	  public GoodsAttrRadioView(Context context, AttributeSet attrs) {
	    super(context, attrs);
	  }
