 ...
 * 商品属性选择框
 * */
public class GoodsAttrDialog extends Dialog implements android.view.View.OnClickListener{
	private Activity activity;
	private ImageButton addNumberButton,minusNumberButton;
	private Button addCartButton,orderButton;//加入购物车，立即购买
//	private TGoods goods;
	private String goodsName,shopPrice,marketPrice;
	private boolean isCollect=false;
	private List<TGoodsAttr> goodsAttrList;
	private TextView  goodsNameView,goodsShopPriceView,goodsMarketPriceView,numberInputView,cartNumberView;
	private ImageView closeButton,collectView;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		this.setContentView(R.layout.activity_goodsdetails_attr);
	...
	public void show(String number) {
		...
		if(MenberUtils.isLogin(activity)){
			int cartNumber=ShoppingCartUitl.getCartNumber(activity);
			if(cartNumber>0){
	...
	public void setAttrInfo(String goodsName,String shopPrice,String marketPrice,boolean isCollect,List<TGoodsAttr> goodsAttrList) {
	...
	public void addListener(GoodsAttrDialog.Listener listener){
		this.listener=listener;
	}
	public interface Listener{
		public void modifyNumber(int number);
		public void modifyGoodsAttrItem(TGoodsAttr.TGoodsAttrItem goodsAttrItem);
		public void addShoppingCart();//加入购物车
