...
public abstract class DRefreshBase<T extends View> extends LinearLayout {
	...
	private void initView(Context context, AttributeSet attrs) {
		...
		this.addView(headerLayout, 0, new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,ViewGroup.LayoutParams.WRAP_CONTENT));
		this.addView(refreshableView, new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT));
		this.addView(footerLayout, -1, new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,300));
    ...
    protected final void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        refreshLoadingViewsSize();
        // 设置刷新View的大小
        LinearLayout.LayoutParams lp = (LinearLayout.LayoutParams) refreshableView.getLayoutParams();
        if (lp.height != h) {
            lp.height = h;
